...
const Header = () => {
  ...
  return (
    <nav
      className={`
      ${darkMode ? "dark bg-black" : "light bg-white"} flex justify-between items-center gap-4 lg:px-20 px-4 py-3 sticky top-0 z-30`}
    >
      <div id="logo">
        <img
          src={logo}
      ...
      <div className=" flex justify-center items-center lg:gap-8 gap-2">
        <div className=" flex justify-center items-center lg:gap-3 gap-1">
          ...
          <h1 className=" lg:text-xl text-sm text-black dark:text-white font-semibold">697647717</h1>
        </div>
